  ...
  actions {
    ...
    dynamic "route_configuration_override_action" {
      ...
      content {
        ...
        cdn_frontdoor_origin_group_id = route_configuration_override_action.value.set_origin_groupid == true ? azurerm_cdn_frontdoor_origin_group.example[each.value.origin_group_name].id : null
